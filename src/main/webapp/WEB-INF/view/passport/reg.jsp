	...
	<div class="container">
		<form id="reg">
			...
			<div class="form-group form-check">
				<input type="radio" name="gender" checked="checked" class="form-check-input" id="man" value="1">
				<label class="form-check-label" for="man">男</label>
				
			</div>
			<div class="form-group form-check">
				<input type="radio" name="gender" class="form-check-input" id="woman" value="0">
		...
		$("#reg").validate({
			...
			rules:{
				...
				password:{
					...
					rangelength:[6,10],//长度5-10之间
					
				},
				repassword:{
					equalTo:"#password",//确认密码和第一次输入的密码要一致
